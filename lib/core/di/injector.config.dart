...
import 'package:videocall/data/data_sources/remote/service/user_service.dart'
    as _i7;
import 'package:videocall/data/repositories/auth_repository_impl.dart' as _i13;
import 'package:videocall/data/repositories/user_repository_impl.dart' as _i10;
import 'package:videocall/domain/modules/auth/auth_repostiory.dart' as _i12;
import 'package:videocall/domain/modules/auth/auth_usecase.dart' as _i14;
import 'package:videocall/domain/modules/user/user_repository.dart' as _i9;
import 'package:videocall/domain/modules/user/user_usecase.dart' as _i11;
import 'package:videocall/presentation/app/bloc/app_bloc.dart' as _i17;
import 'package:videocall/presentation/setting/setting_dash_board/setting_dash_board.dart'
    as _i15;
import 'package:videocall/presentation/welcome/welcome.dart' as _i16;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i7.UserService>(
        () => _i7.UserService(service: gh<_i6.BaseService>()));
    gh.lazySingleton<_i8.AuthService>(
        () => _i8.AuthService(service: gh<_i6.BaseService>()));
    gh.factory<_i9.UserRepository>(
        () => _i10.UserRepositoryImpl(userService: gh<_i7.UserService>()));
    gh.factory<_i11.UserUseCase>(
        () => _i11.UserUseCaseImpl(userRepo: gh<_i9.UserRepository>()));
    ...
    gh.factory<_i14.AuthUseCase>(
        () => _i14.AuthUseCaeImpl(repo: gh<_i12.AuthRepository>()));
    gh.factory<_i15.SettingCubit>(
        () => _i15.SettingCubit(authRepo: gh<_i12.AuthRepository>()));
    gh.factory<_i16.WelcomeCubit>(
        () => _i16.WelcomeCubit(authRepo: gh<_i12.AuthRepository>()));
    gh.lazySingleton<_i17.AppBloc>(
        () => _i17.AppBloc(authRepo: gh<_i12.AuthRepository>()));
    return this;
  }
}
