...
import 'package:videocall/core/services/notification_controller.dart' as _i31;
...
import 'package:videocall/data/repositories/app_settings_repository_impl.dart'
    as _i17;
import 'package:videocall/data/repositories/auth_repository_impl.dart' as _i36;
import 'package:videocall/data/repositories/friend_repository_impl.dart'
    as _i27;
import 'package:videocall/data/repositories/user_repository_impl.dart' as _i33;
...
import 'package:videocall/domain/modules/app_settings/app_settings_usecase.dart'
    as _i18;
import 'package:videocall/domain/modules/auth/auth_repostiory.dart' as _i35;
import 'package:videocall/domain/modules/auth/auth_usecase.dart' as _i37;
...
import 'package:videocall/domain/modules/user/user_repository.dart' as _i32;
import 'package:videocall/domain/modules/user/user_usecase.dart' as _i34;
import 'package:videocall/presentation/app/app_setting_cubit/app_setting_cubit.dart'
    as _i24;
import 'package:videocall/presentation/app/bloc/app_bloc.dart' as _i44;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i14.SignUpPageViewCubit>(() => _i14.SignUpPageViewCubit());
    ...
    gh.factory<_i31.NotificationController>(
        () => _i31.NotificationController(friendUC: gh<_i28.FriendUseCase>()));
    ...
    gh.factory<_i34.UserUseCase>(
        () => _i34.UserUseCaseImpl(repo: gh<_i32.UserRepository>()));
    gh.lazySingleton<_i35.AuthRepository>(() => _i36.AuthRepositoryImpl(
          ...
          userRepo: gh<_i32.UserRepository>(),
        ));
    gh.factory<_i37.AuthUseCase>(
        () => _i37.AuthUseCaeImpl(repo: gh<_i35.AuthRepository>()));
    gh.factory<_i38.FindFriendBloc>(
        () => _i38.FindFriendBloc(userRepo: gh<_i32.UserRepository>()));
    ...
    gh.factory<_i42.SignUpFormCubit>(
        () => _i42.SignUpFormCubit(authRepo: gh<_i35.AuthRepository>()));
    gh.factory<_i43.WelcomeCubit>(
        () => _i43.WelcomeCubit(authRepo: gh<_i35.AuthRepository>()));
    gh.lazySingleton<_i44.AppBloc>(() => _i44.AppBloc(
          authRepo: gh<_i35.AuthRepository>(),
          notificationControllerController: gh<_i31.NotificationController>(),
        ));
    return this;
  }
}
