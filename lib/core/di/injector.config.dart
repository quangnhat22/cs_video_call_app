...
import 'package:awesome_notifications/awesome_notifications.dart' as _i13;
...
import 'package:videocall/data/repositories/app_settings_repository_impl.dart'
    as _i18;
import 'package:videocall/data/repositories/auth_repository_impl.dart' as _i45;
import 'package:videocall/data/repositories/friend_repository_impl.dart'
    as _i33;
import 'package:videocall/data/repositories/group_repository_impl.dart' as _i37;
import 'package:videocall/data/repositories/user_repository_impl.dart' as _i42;
...
import 'package:videocall/domain/modules/app_settings/app_settings_usecase.dart'
    as _i19;
import 'package:videocall/domain/modules/auth/auth_repostiory.dart' as _i44;
import 'package:videocall/domain/modules/auth/auth_usecase.dart' as _i46;
import 'package:videocall/domain/modules/call/call_repository.dart' as _i29;
import 'package:videocall/domain/modules/call/call_usecase.dart' as _i31;
import 'package:videocall/domain/modules/friend/friend_repository.dart' as _i32;
import 'package:videocall/domain/modules/friend/friend_usecase.dart' as _i34;
import 'package:videocall/domain/modules/group/group_repository.dart' as _i36;
import 'package:videocall/domain/modules/group/group_usecase.dart' as _i38;
import 'package:videocall/domain/modules/user/user_repository.dart' as _i41;
import 'package:videocall/domain/modules/user/user_usecase.dart' as _i43;
import 'package:videocall/presentation/app/app_setting_cubit/app_setting_cubit.dart'
    as _i27;
import 'package:videocall/presentation/app/bloc/app_bloc.dart' as _i60;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i11.PersonalCallPage>(() => _i11.PersonalCallPage(
          key: gh<_i12.Key>(),
          receivedAction: gh<_i13.ReceivedAction>(),
          friendId: gh<String>(),
        ));
    gh.factory<_i14.PersonalCallRoomFirebase>(
        () => _i14.PersonalCallRoomFirebase());
    ...
    gh.singleton<_i20.BaseService>(
        _i20.BaseService(interceptor: gh<_i6.DioInterceptor>()));
    gh.factory<_i21.CallService>(
        () => _i21.CallService(service: gh<_i20.BaseService>()));
    gh.factory<_i22.EditLanguageCubit>(
        () => _i22.EditLanguageCubit(usecase: gh<_i19.AppSettingsUseCase>()));
    gh.factory<_i23.EditThemeCubit>(
        () => _i23.EditThemeCubit(usecase: gh<_i19.AppSettingsUseCase>()));
    gh.factory<_i24.FriendService>(
        () => _i24.FriendService(service: gh<_i20.BaseService>()));
    gh.factory<_i25.GroupService>(
        () => _i25.GroupService(service: gh<_i20.BaseService>()));
    gh.lazySingleton<_i26.UserService>(
        () => _i26.UserService(service: gh<_i20.BaseService>()));
    gh.factory<_i27.AppSettingCubit>(
        () => _i27.AppSettingCubit(useCase: gh<_i19.AppSettingsUseCase>()));
    gh.factory<_i28.AuthService>(
        () => _i28.AuthService(service: gh<_i20.BaseService>()));
    gh.factory<_i29.CallRepository>(() => _i30.WebRTCRepositoryImpl(
          callRoomFirebase: gh<_i14.PersonalCallRoomFirebase>(),
          callService: gh<_i21.CallService>(),
        ));
    gh.factory<_i31.CallUseCase>(
        () => _i31.CallUseCaseImpl(callRepo: gh<_i29.CallRepository>()));
    gh.factory<_i32.FriendRepository>(
        () => _i33.FriendRepositoryImpl(service: gh<_i24.FriendService>()));
    gh.factory<_i34.FriendUseCase>(
        () => _i34.FriendUseCaseImpl(friendRepo: gh<_i32.FriendRepository>()));
    gh.factory<_i35.FriendsActionCubit>(
        () => _i35.FriendsActionCubit(friendUC: gh<_i34.FriendUseCase>()));
    gh.factory<_i36.GroupRepository>(
        () => _i37.GroupRepositoryImpl(service: gh<_i25.GroupService>()));
    ...
    gh.factory<_i40.PersonalCallCubit>(
        () => _i40.PersonalCallCubit(callUC: gh<_i31.CallUseCase>()));
    gh.factory<_i41.UserRepository>(() => _i42.UserRepositoryImpl(
    ...
    gh.factory<_i43.UserUseCase>(
        () => _i43.UserUseCaseImpl(repo: gh<_i41.UserRepository>()));
    gh.lazySingleton<_i44.AuthRepository>(() => _i45.AuthRepositoryImpl(
          ...
          userRepo: gh<_i41.UserRepository>(),
        ));
    gh.factory<_i46.AuthUseCase>(
        () => _i46.AuthUseCaeImpl(repo: gh<_i44.AuthRepository>()));
    gh.factory<_i47.AvatarCubit>(
        () => _i47.AvatarCubit(userUc: gh<_i43.UserUseCase>()));
    gh.factory<_i48.CallCubit>(
        () => _i48.CallCubit(callUC: gh<_i31.CallUseCase>()));
    gh.factory<_i49.CreateGroupCubit>(
        () => _i49.CreateGroupCubit(groupUseCase: gh<_i38.GroupUseCase>()));
    gh.factory<_i50.FindFriendBloc>(
        () => _i50.FindFriendBloc(userRepo: gh<_i41.UserRepository>()));
    gh.factory<_i51.FriendRequestActionCubit>(() =>
        _i51.FriendRequestActionCubit(friendUseCase: gh<_i34.FriendUseCase>()));
    gh.factory<_i52.FriendsContactBloc>(() => _i52.FriendsContactBloc(
          useCase: gh<_i34.FriendUseCase>(),
          userUseCase: gh<_i43.UserUseCase>(),
        ));
    gh.factory<_i53.GroupListBloc>(
        () => _i53.GroupListBloc(useCase: gh<_i38.GroupUseCase>()));
    gh.factory<_i54.LoginCubit>(
        () => _i54.LoginCubit(authUseCase: gh<_i46.AuthUseCase>()));
    gh.factory<_i55.ProfileFormCubit>(
        () => _i55.ProfileFormCubit(userUC: gh<_i43.UserUseCase>()));
    gh.factory<_i56.SendEmailCubit>(
        () => _i56.SendEmailCubit(authUseCase: gh<_i46.AuthUseCase>()));
    gh.factory<_i57.SettingCubit>(() => _i57.SettingCubit(
          authUseCase: gh<_i46.AuthUseCase>(),
          userUseCase: gh<_i43.UserUseCase>(),
          appSettingsUseCase: gh<_i19.AppSettingsUseCase>(),
        ));
    gh.factory<_i58.SignUpFormCubit>(
        () => _i58.SignUpFormCubit(authRepo: gh<_i44.AuthRepository>()));
    gh.factory<_i59.WelcomeCubit>(
        () => _i59.WelcomeCubit(authRepo: gh<_i44.AuthRepository>()));
    gh.lazySingleton<_i60.AppBloc>(
        () => _i60.AppBloc(authUC: gh<_i46.AuthUseCase>()));
    return this;
  }
}
