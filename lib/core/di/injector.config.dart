...
import 'package:videocall/presentation/app/app_setting_cubit/app_setting_cubit.dart'
    as _i24;
import 'package:videocall/presentation/app/bloc/app_bloc.dart' as _i54;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i28.CallUseCase>(
        () => _i28.CallUseCaseImpl(callRepo: gh<_i26.CallRepository>()));
    ...
    gh.factory<_i45.FindFriendBloc>(
        () => _i45.FindFriendBloc(userRepo: gh<_i37.UserRepository>()));
    gh.factory<_i46.FriendRequestActionCubit>(() =>
        _i46.FriendRequestActionCubit(friendUseCase: gh<_i31.FriendUseCase>()));
    ...
    gh.factory<_i48.LoginCubit>(
        () => _i48.LoginCubit(authUseCase: gh<_i42.AuthUseCase>()));
    gh.factory<_i49.ProfileFormCubit>(
        () => _i49.ProfileFormCubit(userUC: gh<_i39.UserUseCase>()));
    gh.factory<_i50.SendEmailCubit>(
        () => _i50.SendEmailCubit(authUseCase: gh<_i42.AuthUseCase>()));
    gh.factory<_i51.SettingCubit>(() => _i51.SettingCubit(
          authUseCase: gh<_i42.AuthUseCase>(),
          userUseCase: gh<_i39.UserUseCase>(),
          appSettingsUseCase: gh<_i16.AppSettingsUseCase>(),
        ));
    gh.factory<_i52.SignUpFormCubit>(
        () => _i52.SignUpFormCubit(authRepo: gh<_i40.AuthRepository>()));
    gh.factory<_i53.WelcomeCubit>(
        () => _i53.WelcomeCubit(authRepo: gh<_i40.AuthRepository>()));
    gh.lazySingleton<_i54.AppBloc>(
        () => _i54.AppBloc(authUC: gh<_i42.AuthUseCase>()));
    return this;
  }
}
