...
part 'pages/create_schedule_page.dart';
part 'pages/schedule_dash_board_page.dart';
...
part 'widgets/form_fields/title_text_form_field.dart';
part 'widgets/schedule_add_notifications.dart';
part 'widgets/schedule_add_participants.dart';
part 'widgets/schedule_in_progress.dart';
part 'widgets/schedule_item.dart';
