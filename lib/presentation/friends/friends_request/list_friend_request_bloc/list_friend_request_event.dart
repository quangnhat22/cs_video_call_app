...
class ListFriendRequestEvent with _$ListFriendRequestEvent {
  ...
  const factory ListFriendRequestEvent.listRequestRefreshed() =
      ListFriendRequestRefreshed;

  const factory ListFriendRequestEvent.listRequestSentRefreshed() =
      ListSentFriendRequestRefreshed;

  const factory ListFriendRequestEvent.listRequestReceiveRefreshed() =
      ListReceiveFriendRequestRefreshed;
}
